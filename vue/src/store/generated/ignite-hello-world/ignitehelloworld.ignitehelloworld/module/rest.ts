 ...
 */
export interface IgnitehelloworldQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: IgnitehelloworldParams;
}
...
/**
 * @title ignitehelloworld/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/ignite-hello-world/ignitehelloworld/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<IgnitehelloworldQueryParamsResponse, RpcStatus>({
      path: `/ignite-hello-world/ignitehelloworld/params`,
      method: "GET",
      format: "json",
      ...params,
    });
