...
import IgniteHelloWorldIgnitehelloworldIgnitehelloworld from './ignite-hello-world/ignitehelloworld.ignitehelloworld'
...
export default { 
  ...
  IgniteHelloWorldIgnitehelloworldIgnitehelloworld: load(IgniteHelloWorldIgnitehelloworldIgnitehelloworld, 'ignitehelloworld.ignitehelloworld'),
